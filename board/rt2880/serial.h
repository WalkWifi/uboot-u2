...
#define CFG_RT2880_CONSOLE	RT2880_UART3    //weikk add 2015.10.17
#else
...
#define HSP(x)		__REG(RALINK_SYSCTL_BASE+(x)+0X24)  //weikk 20160719
#define SPC(x)		__REG(RALINK_SYSCTL_BASE+(x)+0X28)
